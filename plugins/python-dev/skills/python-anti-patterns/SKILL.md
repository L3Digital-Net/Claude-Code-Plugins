...
description: Python anti-pattern checklist. MUST consult before finalizing any Python implementation, during Python code review, or when a Python bug traces to mutable defaults, bare except, circular imports, or other known traps.
---
