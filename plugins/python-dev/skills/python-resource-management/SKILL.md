...
description: Python resource management — context managers, __enter__/__exit__, contextlib, cleanup patterns. MUST consult when writing context managers, managing connections/file handles, implementing cleanup logic, or building streaming responses in Python.
---
...
def timed_block(name: str):
    ...
    try:
        ...
        logger.info("block_completed", name=name, duration_seconds=round(elapsed, 3))
