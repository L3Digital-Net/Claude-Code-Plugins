...
description: Python code style — ruff, black, isort, naming conventions, docstrings. MUST consult when configuring Python linters/formatters, establishing project style standards, or when style questions arise during Python code review.
---
