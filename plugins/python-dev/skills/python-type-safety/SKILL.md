...
description: Python type safety — type hints, generics, Protocol, TypeVar, mypy, pyright. MUST consult when adding type annotations, implementing generic classes, defining structural interfaces (Protocol), or configuring mypy/pyright in Python projects.
---
