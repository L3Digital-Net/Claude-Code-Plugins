...
description: Python resilience — tenacity, retries, exponential backoff, circuit breakers, timeouts. MUST consult when adding retry logic, implementing timeouts, wrapping external API calls with fault tolerance, or handling transient failures in Python.
---
