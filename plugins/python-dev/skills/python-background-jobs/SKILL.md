...
description: Python background job patterns — Celery, RQ, dramatiq, task queues, workers. MUST consult when adding background tasks, job queues, long-running operations, worker processes, or decoupling work from request/response cycles in Python.
---
