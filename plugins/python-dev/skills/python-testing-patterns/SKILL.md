...
description: Python test patterns — pytest fixtures, parametrize, mocking, conftest, coverage. MUST consult as a reference when writing pytest fixtures, parametrized tests, mock strategies, or structuring Python test suites. Complements superpowers:test-driven-development (which drives the workflow).
---
