...
description: Python configuration management — pydantic-settings, environment variables, .env files, secrets. MUST consult when externalizing config, adding settings classes, managing secrets, or implementing environment-specific behavior in Python.
---
