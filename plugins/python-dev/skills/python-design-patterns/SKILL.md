...
description: Python design patterns — KISS, SoC, SRP, composition over inheritance, dependency injection. MUST consult when refactoring Python classes, choosing between inheritance and composition, implementing dependency injection, extracting abstractions, or restructuring Python modules.
---
